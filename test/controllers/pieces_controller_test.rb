...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference('Piece.count') do
      post pieces_url, params: { piece: { player_id: @piece.player_id, spot_id: @piece.spot_id } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { player_id: @piece.player_id, spot_id: @piece.spot_id } }
